...
- [2. 우리는 무엇을 하려는 건가요?](#2----)
  - [2-1. 소프트웨어 개발 절차](#2-1---)
  - [2-2. 소프트웨어 구성원의 역할](#2-2---)
  - [2-3. 학습 목표 (최종적으로 알려주고 싶은 것.)](#2-3------)
- [3. 왜 Flask인가요?](#3--flask)
  - [3-1. Flask를 왜 배워요?](#3-1-flask--)
  - [3-2. 요즘 스타트업들이 Python+Flask로 개발하고 Java+Spring으로 넘어간다](#3-2---pythonflask--javaspring-)
- [4. 개발 환경 세팅](#4---)
  - [4-1. 사용 스택 체크](#4-1---)
  - [4-2. 설치 및 설정](#4-2---)
- [5. 요약](#5-)
