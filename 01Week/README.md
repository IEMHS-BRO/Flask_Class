...
- [2. 우리는 무엇을 하려는 건가요?](#2-----------------)
  * [2-1. 소프트웨어 개발 절차](#2-1------------)
    ...
    + [ex) 배달의민족의 배민페이 시스템](#ex-----------------)
  * [2-2. 소프트웨어 구성원의 역할](#2-2--------------)
  * [2-3. 학습 목표 (최종적으로 알려주고 싶은 것.)](#2-3------------------------)
- [3. 왜 Flask인가요?](#3---flask----)
  * [3-1. Flask를 왜 배워요?](#3-1-flask--------)
    + [1) Flask**란?**](#1--flask------)
    + [2) 마이크로(micro)의 의미가 무엇인가요?](#2-------micro-------------)
    + [3) Flask와 Django의 차이점](#3--flask--django-----)
    + [4) 인지도(?) 비교](#4-----------)
    + [5) 어느 프레임워크가 더 좋은가요?](#5-------------------)
  * [3-2. 요즘 스타트업들이 Python+Flask로 개발하고 Java+Spring으로 넘어간다](#3-2-----------python-flask-------java-spring-------)
- [4. 개발 환경 세팅](#4---------)
  * [4-1. 사용 스택 체크](#4-1---------)
    + [1) PIP는 무엇인가요?](#1--pip--------)
    + [2) 가상환경은 무엇인가요?](#2--------------)
  * [4-2. 설치 및 설정](#4-2--------)
    + [1) Anaconda 설치](#1--anaconda---)
    + [2) Anaconda 가상환경 생성](#2--anaconda--------)
    + [3) Flask 설치](#3--flask---)
    + [4) 에디터에 가상환경 연결(Visual Studio Code)](#4---------------visual-studio-code-)
    + [5) 테스트](#5-----)
- [5. 요약](#5---)
